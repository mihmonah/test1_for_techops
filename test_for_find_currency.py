...
# In this test case we check that chosen currency doesn't change after clicking between tables "Динамика изменения курсов" and "Расширенная таблица курсов"

@pytest.mark.parametrize("input_currency", [(0, "RUR"), (1, "CHF"), (2, "EUR"), (3, "GBP"), (4, "JPY"), (5, "USD")],
